...
def generate_launch_description():
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'cpr_a300_0001/cmd_vel@geometry_msgs/msg/TwistStamped[gz.msgs.Twist'
                ,
                '/model/cpr_a300_0001/robot/cmd_vel@geometry_msgs/msg/TwistStamped]gz.msgs.Twist'
                ,
            ]
        ,
        remappings=
            [
                (
                    'cpr_a300_0001/cmd_vel'
                    ,
                    'cmd_vel'
                )
                ,
                (
                    '/model/cpr_a300_0001/robot/cmd_vel'
                    ,
                    'platform/cmd_vel'
                )
                ,
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/cpr_a300_0001/robot/tf@tf2_msgs/msg/TFMessage[gz.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
